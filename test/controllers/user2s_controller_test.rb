...
class User2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user2" do
    assert_difference('User2.count') do
      post user2s_url, params: { user2: { email: @user2.email, first_name: @user2.first_name, last_name: @user2.last_name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update user2" do
    patch user2_url(@user2), params: { user2: { email: @user2.email, first_name: @user2.first_name, last_name: @user2.last_name, password: 'secret', password_confirmation: 'secret' } }
